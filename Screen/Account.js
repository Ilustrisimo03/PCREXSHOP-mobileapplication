        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView style={styles.scrollViewContent}>
                ...
                <View style={styles.actionsSection}>
                    ...
                    <Icon name="logout" size={24} color="#1C1C1C" />
...
const styles = StyleSheet.create({
    ...
    orderStatusText: {
     ...
     actionsSection: {
        paddingHorizontal: 20,
        // alignItems: 'center', // Removed as it aligns children to center, we need them full width
        marginBottom: 20,
    },
    actionButton: {
        flexDirection: 'row',
        alignItems: 'center',
        // backgroundColor: '#EAEAEA', // Changed to match the image's subtle background or no background
        paddingVertical: 15,
        paddingHorizontal: 0, // Removed horizontal padding to match image's left alignment of text
        borderRadius: 0, // Removed border radius to match image's sharp edges
        width: '100%',
        marginBottom: 0, // Removed margin bottom to have no spacing between items
    ...
    actionButtonText: {
        ...
        marginLeft: 15,
        fontFamily: 'Rubik-Medium',
        flex: 1, // Allows the text to take up available space, pushing arrow to the right
    },
    arrowIcon: {
        marginLeft: 'auto', // Pushes the arrow icon to the far right
    },
    logoutButton: { // Example for a distinct logout button if needed
        flexDirection: 'row',
        alignItems: 'center',
        ...
        borderRadius: 15,
        width: '45%',
        alignSelf: 'center', // Center the button if it has a fixed width
        marginTop: 20,
    },
    logoutButtonText: {
        fontSize: 16,

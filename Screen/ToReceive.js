    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={[styles.headerTitle, { fontFamily: 'Rubik-Bold' }]}>To Receive</Text>
            </View>
            <FlatList
...
const styles = StyleSheet.create({
    ...
    headerTitle: { fontSize: 22, marginLeft: 16, color: '#212529' }, // Apply fontFamily directly to Text
    ...
    orderId: { fontSize: 13, color: '#868E96' }, // Apply fontFamily directly to Text
